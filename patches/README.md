...
| 3 | src/core/agent/ClaudianService.ts | ~5 | Fetch memory context when building query options |
| 4 | src/main.ts | ~8 | Initialize ChimeraManager in lifecycle |
| 5 | src/features/chat/controllers/ConversationController.ts | ~5 | Post-session memory extraction hook |
| 6 | src/features/settings/ClaudianSettings.ts | ~3 | Add Chimera settings section |
