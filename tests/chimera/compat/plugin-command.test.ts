...
import { PluginCommandHandler, PluginCommandContext } from "../../../src/chimera/compat/plugin-command";
import { PluginCommandSettings } from "../../../src/chimera/types";

// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------

/** Default settings matching the shape PluginCommandHandler expects. */
const DEFAULT_SETTINGS: PluginCommandSettings = {
  marketplaces: {
...
function makeContext(vault: Vault): PluginCommandContext {
  return {
    vault,
    settings: { ...DEFAULT_SETTINGS, marketplaces: { ...DEFAULT_SETTINGS.marketplaces } },
