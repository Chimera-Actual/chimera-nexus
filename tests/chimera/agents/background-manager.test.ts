...
import { BackgroundManager } from "../../../src/chimera/agents/background-manager";
import { AgentDefinition } from "../../../src/chimera/types";
...
function makeTemplateResolver() {
  return {
    resolve: jest.fn().mockImplementation((t: string) => t),
  };
}
...
describe("BackgroundManager", () => {
  ...
  let templateResolver: ReturnType<typeof makeTemplateResolver>;
  ...
  beforeEach(() => {
    ...
    templateResolver = makeTemplateResolver();
