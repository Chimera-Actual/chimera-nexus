...
import { ChimeraMemorySettings, MemoryFile, MemoryTier } from "../types";
...
export class DreamRunner {
   ...
   * @param settings - Memory settings (e.g. `dreamEnabled` flag).
   */
  constructor(
   ...
   * - Target range: {@link _TARGET_MIN_FILES}--{@link _TARGET_MAX_FILES} knowledge files.
   */
   ...
   * character bigrams (Sorensen--Dice coefficient).
   */
