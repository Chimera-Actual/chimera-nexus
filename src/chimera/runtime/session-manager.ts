...
/** Minimal settings shape required by SessionManager. */
...
export class SessionManager {
  ...
  /**
   * @param settings - Settings object containing `maxConcurrentSessions`.
   */
  constructor(private readonly settings: SessionManagerSettings) {
