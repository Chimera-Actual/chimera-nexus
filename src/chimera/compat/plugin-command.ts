...
import { MarketplaceLoader } from "./marketplace-loader";
import { PluginCommandSettings, MarketplaceIndex } from "../types";
...
export interface PluginCommandContext {
  ...
  settings: PluginCommandSettings;
...
export class PluginCommandHandler {
   ...
   * @param _context - Runtime context (unused directly, kept for symmetry).
   */
  ...
  private async fetchMarketplaceIndex(
    source: string,
    context: PluginCommandContext
  ): Promise<MarketplaceIndex | undefined> {
